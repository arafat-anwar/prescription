...
class OptionsController extends Controller
{
    ...
    {
        // $menus = Menu::doesntHave('options')->where('route','!=','#')->where('id', '>', 80)->get();
    ...
    public function store(Request $request)
    {
        ...
        foreach(explode(',', $request->name) as $name){
            $option = Option::create([
                ...
                'submenu_id' => empty($request->submenu_id) ? 0 : $request->submenu_id,
                'desc' => $request->desc,
            ]);
        }
    ...
    public function show($data)
    {
        ...
        // $menus = Menu::doesntHave('options')->where('route','!=','#')->where('id', $menu_id)->get();
        // foreach ($menus as $key => $menu) {
        //     $array = array(
        //         array(
        //             'name' => 'create',
        ...
        // $submenus = Submenu::doesntHave('options')->where('route','!=','#')->where('id', $submenu_id)->get();
