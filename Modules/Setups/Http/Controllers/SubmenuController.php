...
class SubmenuController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $submenu->route = $request->route == "#" ? $request->route : \Str::slug($request->route);
        $submenu->save();

        return is_save($submenu,'Submenu Has been Added.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return is_save($submenu,'Submenu has been updated');
    }
